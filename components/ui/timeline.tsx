          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-zinc-900 flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-zinc-600 border border-zinc-700 p-2" />
              </div>
              <h3 className="hidden md:block text-sm md:pl-20 font-bold text-neutral-500 dark:text-neutral-500 ">
                {item.title}
              </h3>
            </div>
