  ...
  return (
    <div className="h-screen w-full relative px-4">
      ...
      >
        ...
        <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold text-transparent bg-gradient-to-b from-zinc-300 to-zinc-500 bg-clip-text text-center tracking-tight gradient-text-support">
          The open-source <br />
        ...
        <div className="flex items-center gap-2 mt-8 w-fit mx-auto z-10">
