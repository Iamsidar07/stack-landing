...
![Terminal after running npx hardhat init command](/sign-in.webp)
...
![Installing dependencies](/email.webp)
...
![VScode folder structure](/dashboard.webp)
